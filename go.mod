module github.com/kanengo/wdeployer

go 1.22.5

replace github.com/ServiceWeaver/weaver => ../weaver

replace github.com/ServiceWeaver/weaver-kube => ../weaver-kube

require (
	github.com/ServiceWeaver/weaver v0.24.3
	github.com/ServiceWeaver/weaver-kube v0.0.0-00010101000000-000000000000
